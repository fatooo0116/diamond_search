...
add_action( 'rest_api_init', function () {
  register_rest_route( 'cargo/v1', '/get_diamonds3', array(
    'methods' => 'POST',
    'callback' => 'get_diamonds_handler3',
  ) );
});
function get_diamonds_handler3($data){
...
/*  ===========   Create  ===========  */
add_action( 'rest_api_init', function () {
  register_rest_route( 'cargo/v1', '/create_diamond3', array(
    'methods' => 'POST',
    'callback' => 'create_diamond_handler3',
  ) );
});


function create_diamond_handler3($data){
...
/*  ===========   Edit  ===========  */
  add_action( 'rest_api_init', function () {
    register_rest_route( 'cargo/v1', '/edit_diamond3', array(
      'methods' => 'POST',
      'callback' => 'edit_diamond_handler3',
    ) );
  });
  
  

function edit_diamond_handler3($data){
...
/*  ===========   DEL  ===========  */
add_action( 'rest_api_init', function () {
  register_rest_route( 'cargo/v1', '/del_diamond3', array(
    'methods' => 'POST',
    'callback' => 'del_diamond_handler3',
  ) );
});
function del_diamond_handler3($data){
  ...
  foreach($pid as $in){
   ...
   // }
    ...
    /*  ===========   Edit ORder  ===========  */
    add_action( 'rest_api_init', function () {
      register_rest_route( 'cargo/v1', '/order_diamond3', array(
      'methods' => 'POST',
      'callback' => 'order_diamond_handler3',
      ) );
  });


  function order_diamond_handler3($res){
    ...
    add_action( 'rest_api_init', function () {
      register_rest_route( 'cargo/v1', '/fe_get_diamonds3', array(
        'methods' => 'POST',
        'callback' => 'fe_get_diamonds3_handler',
      ) );
    });
    function fe_get_diamonds3_handler($data){      
