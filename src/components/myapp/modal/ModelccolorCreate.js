...
import {create_ccolor } from '../rest/func_rest_ccolor';

        

class ModelccolorCreate extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = (e) =>{
      ...
      if(this.handleValidation()){
         ...
         // console.log(fields);
          ...
          create_ccolor(fields,function(data){
            me.setState({
              is_Open:false,
              fields: {}
            });
...
export default hot(module)(ModelccolorCreate);