...
import {create_carat } from '../rest/func_restcarat';

        

class ModelCaratCreate extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = (e) =>{
      ...
      if(this.handleValidation()){
         ...
         // console.log(fields);
          ...
          create_carat(fields,function(data){
            me.setState({
              is_Open:false,
              fields: {}
            });
...
export default hot(module)(ModelCaratCreate);