...
import { edit_clean } from '../rest/func_rest_clean';

class ModelcleanEdit extends React.Component {
    constructor(props) {
        super(props);
    ...
    handleSubmit = (e) =>{
      ...
      if(this.handleValidation()){
          ...
          edit_clean(fields,function(data){
        ...
        <Modal  className="aloha_modal" show={is_Open} onHide={this.handleClose}>
          <form onSubmit={this.handleSubmit}>
            ...
            <Modal.Body>            
              ...
              <label>
              顏色: <input type="text" onChange={this.handleChange.bind(this, "type_name")} value={this.state.fields["type_name"]} />
...
export default hot(module)(ModelcleanEdit);